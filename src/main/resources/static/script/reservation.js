$(document)
		.ready(
				function() {
					...
					var newLigne = '<tr style="position: relative;" class="bg-lightxx" ><th scope="row">'+ id+ '</th><td colspan="4" style="height: 100%;">';
				...
				var creneau = $(this).closest('tr').find('td').eq(2).text();
